...
The codebase is **modular and cached** for reproducibility and efficient iteration. Each stage writes its artifacts to  `nevermore/outputs/<step>/<signature>/` and is automatically **skipped** when inputs and configuration are unchanged. 
